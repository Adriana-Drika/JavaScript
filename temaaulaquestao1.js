...
*/
  ...
  let  marcas = [ 'Fiat', 'Ford', 'Honda', 'Volkswagen', 'Land', 'BMW', 'Peugeot', 'Renault' ];
  let  modelos = [ 'Uno', 'Mustang', 'Civic', 'Jetta', 'Rover', 'X5', '208', 'Sandero', 'Duster' ];
  let  anosFabricacao = [ 2005, 2015, 2018, 2010, 2022, 2022, 2008, 2009, 2007 ];
